...
<form action="<?= $role ? '/admin/roles/edit/' . $role->id : '/admin/roles/create' ?>" method="POST" class="max-w-5xl">
    ...
    <?php Form::section(function () use ($role) { ?>
        <div class="space-y-4">
            ...
            <?php Page::alert('info', 'Важно!', 'Препоръчително е само една роля да бъде зададена като „по подразбиране“ (обикновено с най-ниски правомощия), за да се гарантира сигурността на системата.'); ?>
        </div>
