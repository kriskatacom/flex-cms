...
<form action="<?= $role ? '/admin/roles/edit/' . $role->id : '/admin/roles/create' ?>" method="POST" class="max-w-5xl">
    ...
    <?php Form::section(function () use ($role) { ?>
        <div class="space-y-4">
            ...
            <div
                class="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/30 rounded-xl flex gap-3">
                <i class="fa-solid fa-circle-info text-blue-500 mt-0.5"></i>
                <p class="text-blue-700 dark:text-blue-300 leading-relaxed">
                    <strong>Важно:</strong> Препоръчително е само една роля да бъде зададена като „по подразбиране“
                    (обикновено с най-ниски правомощия), за да се гарантира сигурността на системата.
                </p>
            </div>
        </div>
